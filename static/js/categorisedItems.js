...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function showCategoriesOverlay() {
    ...
    // Inject categories close button if not exists
  ...
  /* ------------------------------
     Inject categories overlay close button
  -------------------------------*/
  function injectCategoriesCloseButton() {
    ...
    if (overlay && !document.getElementById("categories-close-btn")) {
      ...
      closeBtn.style.zIndex = "1001"; // Above overlay content
  ...
  // Backdrop click closes everything (goes back to dashboard)
